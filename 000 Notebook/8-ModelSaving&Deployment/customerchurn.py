...
def run_app():
    ...
    labels = {
        ...
        'ar': {
            "app_title": "نموذج الذكاء الاصطناعي لتوقع مغادرة عملاء البنك",
            "title": "بيانات العميل",
            'Age': 'العمر',
            'Balance': 'الرصيد',
    ...
    with col5:
        # Geography selection with translation
